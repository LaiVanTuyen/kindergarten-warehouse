...
CREATE TABLE favorites (
    ...
    CONSTRAINT fk_favorites_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE CASCADE
);
...
CREATE TABLE comments (
    ...
    CONSTRAINT fk_comments_updated_by FOREIGN KEY (updated_by) REFERENCES users(id) ON DELETE CASCADE
);
